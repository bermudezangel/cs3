//
//	CS2 - Lsn6609                                © 2015 - Cypress Creek HS
//
// 	   Thread:	Algoritm Analysis - Insertion Sort
//	Criterion:	Binary Insertion Sort
//	========================================================================
//
//
//
/*
	...
	public void sort()
	{
		for(int pivot=0; pivot<list.length; pivot++)
		{
			...
			// Search
			int loc 	= linearSearch(entry, pivot);

			// Insert
			insertEntry(entry, pivot, loc);
		}
	}
...
class Environment
{
	...
	public void sort()
	{
		for(pivot=0; pivot<list.length; pivot++)
		{
			...
			// Search
			int loc 	= binarySearch(entry, pivot);
